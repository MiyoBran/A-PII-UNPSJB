...
public class StackPerformanceTest {
    ...
    private static void measurePushOperation(Stack<Integer> arrayStack, Stack<Integer> linkedStack,
        ...
        long endTime = System.nanoTime();
        System.out.println("  ArrayStack: " + (endTime - startTime) / 100000.0 + " ms");
        ...
        endTime = System.nanoTime();
        System.out.println("  LinkedStack: " + (endTime - startTime) / 100000.0 + " ms");
        ...
        endTime = System.nanoTime();
        System.out.println("  DoublyLinkedStack: " + (endTime - startTime) / 100000.0 + " ms");
    }
